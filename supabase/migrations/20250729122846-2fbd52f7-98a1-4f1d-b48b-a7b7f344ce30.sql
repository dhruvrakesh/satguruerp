-- Phase 1: Create approval records for existing submitted POs
-- First, let's call the auto_create_po_approvals function for any submitted POs that don't have approval records
DO $$
DECLARE
    po_record RECORD;
BEGIN
...
-- Phase 2: Create trigger to automatically create approval records when PO is submitted
...
-- Phase 3: Fix the get_user_pending_approvals function to handle parameter correctly
