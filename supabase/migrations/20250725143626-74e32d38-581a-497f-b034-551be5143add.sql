...
-- Create test orders with today's date
INSERT INTO public.orders_dashboard_se (uiorn, item_code, customer_name, status, created_at, last_activity) VALUES
('260125_0001', 'ITM-IKRISH-001', 'IKRISH', 'IN_PROGRESS', now(), 'Order created for testing'),
('260125_0002', 'ITM-SRS-002', 'SRS', 'IN_PROGRESS', now(), 'Order created for testing'),
('260125_0003', 'ITM-GLOB-002', 'Global', 'IN_PROGRESS', now(), 'Order created for testing')
