...
-- FINAL FIXES: Complete ERP System Operationalization
-- Fix remaining issues identified in comprehensive analysis

-- Phase 1: Fix Cutoff Date Function to July 21, 2025
...
-- Phase 3: Enhanced Stock Summary View with Better 30-Day Metrics
  ...
  *,
  ...
  CASE 
    WHEN current_qty <= 0 THEN 
      CASE WHEN data_quality = 'LEGACY_NEGATIVE' THEN 'out_of_stock' ELSE 'out_of_stock' END
