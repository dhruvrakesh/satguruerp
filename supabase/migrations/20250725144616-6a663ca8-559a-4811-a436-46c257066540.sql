...
('260125_0001', 'ITM-IKRISH-001', 'WRAPPER COOL MINT 100G', 'BOPP', CURRENT_DATE, now(), 'Order created for testing'),
('260125_0002', 'ITM-SRS-002', 'Jimny-Lime&Aloevera', 'BOPP', CURRENT_DATE, now(), 'Order created for testing'),
('260125_0003', 'ITM-GLOB-002', 'Soap-Rose', 'BOPP', CURRENT_DATE, now(), 'Order created for testing')
