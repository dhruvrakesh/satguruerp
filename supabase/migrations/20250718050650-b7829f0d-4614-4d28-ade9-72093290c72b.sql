-- Fixed Data Migration & Master Data Population
...
SELECT 
  ...
  CASE 
    WHEN printing_done_at IS NOT NULL AND lamination_done_at IS NOT NULL AND slitting_done_at IS NOT NULL AND dispatch_done_at IS NOT NULL THEN 'COMPLETED'::order_status
    WHEN printing_done_at IS NOT NULL THEN 'IN_PROGRESS'::order_status
