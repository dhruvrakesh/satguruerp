-- Phase 3-5: Performance Optimization & Enterprise Features (Fixed)
...
-- Function to get category performance metrics (Fixed interval syntax)
...
BEGIN
    ...
    WITH usage_stats AS (
        ...
        WHERE cut.created_at >= now() - (p_days || ' days')::interval
