...
-- Fix the validate_issue_batch_all function to use calculate_current_stock for accurate stock levels
...
BEGIN
    ...
    FOR i IN 0..v_total_items-1 LOOP
        ...
        -- Use calculate_current_stock for accurate stock calculation
        ...
        RAISE LOG 'Stock calculation for %: current_stock=%, item_name=%', 
