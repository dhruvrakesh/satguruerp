-- DEFINITIVE CLEANUP: Remove ALL conflicting function versions
-- This migration forcefully removes all function overloads and creates single authoritative versions

-- Drop ALL versions of problematic functions (using CASCADE to handle dependencies)
DROP FUNCTION IF EXISTS public.generate_predictive_insights CASCADE;
DROP FUNCTION IF EXISTS public.get_advanced_manufacturing_analytics CASCADE;
